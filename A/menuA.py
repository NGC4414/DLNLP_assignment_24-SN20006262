...
def print_menu_A():
    ...
    print("6. RoBERTa (train on your machine) - full dataset")
    print("7. RoBERTa (train on your machine) - sampled dataset")
    print("--------------ALBERT-------------")
    print("8. ALBERT (pre-trained) - sampled dataset")
    print("9. ALBERT (train on your machine) - sampled dataset")
...
def run_task_A():     
    ...
    while True:
        ...
        if option == 1:
            ...
            books_file_path = r"./Datasets/books/books.csv"
            ...
            eda_books(reduced_books_file_path_400m, plt_title1 = 'Genre Distribution (sampled)', plt_title2 = 'Summary Length Distribution (sampled)', plt_title3= 'Average Summary Length per Genre (sampled)')
            ...
            train_dataset, val_dataset, test_dataset = split_dataset(dataset, train_frac=0.8, test_frac=0.1, val_frac=0.1, seed=42, 
                                                                     train_dataset_path='./Datasets/books/Roberta/train_dataset_full.pt', 
                                                                     val_dataset_path ='./Datasets/books/Roberta/val_dataset_full.pt', 
                                                                     test_dataset_path='./Datasets/books/Roberta/test_dataset_full.pt')
            
            print('Loading training, validation and test pytorch datasets...')
            train_dataset, val_dataset, test_dataset =  load_datasets_from_files(train_dataset_path='./Datasets/books/Roberta/train_dataset_full.pt',
                                                                                 val_dataset_path ='./Datasets/books/Roberta/val_dataset_full.pt',
                                                                                 test_dataset_path ='./Datasets/books/Roberta/test_dataset_full.pt')
            ...
            training_stats = train_model(train_dataloader, valid_dataloader, num_labels, model_name= "roberta-base", model_path  = 'A/models/roberta_f.bin', epochs=3, learning_rate=2e-5, epsilon=1e-8)
